...
`public-opinion-agent@0.3.20` is the Codex edition of the evidence-backed Chinese
...
0.3.20 can coexist. Existing Sessions stay pinned to their version and route snapshot;
