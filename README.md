# AXENO · Agent Operations Platform

AXENO 是面向组织的智能体任务、能力与运行治理平台。它以 Claude Agent SDK 为执行内核，把智能体定义、任务运行、能力装配、协作权限、评测发布和审计治理收束到一条可恢复的执行链路中。

当前发布候选为 **AXENO 0.2.0**。Claude Agent SDK 提供 Agent Loop、工具、Skills、
