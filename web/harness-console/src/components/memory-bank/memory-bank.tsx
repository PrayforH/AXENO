...
export function MemoryBank() {
  ...
  return <main className={styles.shell} id="main-content">
    <header className={styles.topbar}><Link className={styles.brand} href="/"><span>AS</span><div><strong>Agent Studio</strong><small>智能任务工作台</small></div></Link><div className={styles.topbarActions}><ThemeToggle className={styles.themeToggle}/><Link className={styles.back} href="/settings">返回设置</Link></div></header>
